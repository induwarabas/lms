...
<div class="customer-view">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            'id',
            ['attribute'=>'nic', 'value'=>function($data){return NICValidator::formatNicNo($data->nic);}],
            'full_name',
            'name',
            'dob',
            'gender',
            ...
            'occupation',
            'work_address:ntext',
            ['attribute'=>'work_phone', 'value'=> function($data) {return PhoneNoFormatter::format($data->work_phone);}],
            'work_email:email',
            'fixed_salary',
            'other_incomes',
            'spouse_id',
