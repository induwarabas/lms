...
<div class="supplier-create">
    ...
    <?php if ($model->stage == 1) { ?>
        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ['attribute' => 'dr_account', 'format' => 'html', 'value' => AccountView::widget(['accountId' => Account::createAccountId(Account::TYPE_TELLER, $model->dr_account)]) . " : " . Account::findOne(Account::createAccountId(Account::TYPE_TELLER, $model->dr_account))->getAccountName()],
                ['attribute' => 'cr_account', 'format' => 'html', 'value' => AccountView::widget(['accountId' => $model->cr_account]) . " : " . Account::findOne($model->cr_account)->getAccountName()],
                'payment',
                'cheque',
...
$('#grr').click(function(e){
    ...
    $('#frmx').attr('action', '" . \yii\helpers\Url::to(['transaction/safe-to-teller']) . "').submit();
