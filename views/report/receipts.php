...
<div class="loan-index">
    ...
    <?= $form->field($searchModel, 'teller')->dropDownList(['' => 'All'] + ArrayHelper::map($users, 'username', 'username')) ?>
    ...
    <?php } else {
        ...
        if ($searchModel->teller != null) {
            echo "<tr><th>Teller</th><td>: " . $searchModel->teller . "</td></tr>";
        }
